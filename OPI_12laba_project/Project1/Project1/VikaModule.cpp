	...
	case 1: { // Вычисление дня недели при вводе 1 группы
		...
		if (number_weak == 1 || number_weak % 2 != 0) { // Проверка реальности введённых данных
			...
			if (number < 7) { // Проверка на реальность введённых данных
				switch (number) {
				case 1: {
					cout << "16:30-17:50| лк Компрьютерные языки разметки" << endl;
				...
				case 3: {
					cout << "13:00-14:20| пз Физическая культура" << endl;
				...
				case 4: {
					...
					cout << "18:05-19:25| пз Линейная алгебра и аналитическая геометрия" << endl; break; }
				case 5: {
					cout << "14:40-16:00| лр Компьтерные языки разметки" << endl;
					cout << "16:30-17:50| пз Физическая культура" << endl;
					cout << "18:05-19:25| лк Основы программной инженерии" << endl; break; }
				case 6: {
					cout << "11:25-12:45| лк Линейная алгебра и аналитическая геометрия" << endl;
					cout << "13:00-14:20| лр Основы программной инженерии" << endl;
	...
	case 2: { // Вычисление дня недели при вводе 2 недели
		...
		if (number_weak == 1 || number_weak % 2 != 0) {
			...
			if (number < 7) {
				switch (number) {
				case 1: {
					cout << "14:40-16:00| лр Основы алгоритмизации и программирования" << endl;
